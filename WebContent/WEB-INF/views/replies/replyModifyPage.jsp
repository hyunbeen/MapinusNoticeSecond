...
<!-- 페이지의 js -->
<script
	src="${pageContext.request.contextPath}/resources/dist/js/replies/reviewModifyPage.js"></script>
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<!-- 댓글 수정 하기의 폼 -->
				<div class="box-body">
					<form action='../replies/replyModify' method='post' id='frm'>
						...
						<div class="form-group">
							<label for="exampleInputEmail1">글쓴이</label> <input type="text"
								id="r_user" name="r_user" class="form-control" value="${r_user}"
								readonly="readonly">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">내용</label>
							<textarea class="form-control" id="r_content" name="r_content"
								rows="3">${r_content}</textarea>
						</div>
					</form>
				</div>
				<!-- /.box-body -->
				...
				<div class="box-footer">
					<button type="button" class="btn btn-primary" id="replyModifyBtn">저장</button>
